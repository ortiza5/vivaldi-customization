(function () {
  // ============================================================================================================
  // Gives Zoom Interface in the Tab Bar - with visible reset button
  ...
  function zoomControlStatic() {
    ...
    function updatePercent(zoomInfo) {
      ...
      if (!alreadyExists) {
        ...
        zoomControls.innerHTML = `
            <div class="page-zoom-controls-s">
                <div class="button-toolbar-s reset-zoom-s" title="Reset Zoom">
                  <button tabindex="-1" class="button-textonly-s slight-padding" id="zoom-reset-s">
                ...
                <div class="button-toolbar-s reset-zoom-s" title="Reset Zoom">
                    <button tabindex="-1" class="button-textonly-s">
        ...
        document.getElementById("zoom-in-s").addEventListener("dblclick", function (e) {
          e.stopPropagation();
        });

        // prevents double clicks from resizing the window
        document.getElementById("zoom-out-s").addEventListener("dblclick", function (e) {
          e.stopPropagation();
        });

        // prevents double clicks from resizing the window
        document.getElementById("zoom-reset-s").addEventListener("dblclick", function (e) {
          e.stopPropagation();
        });
