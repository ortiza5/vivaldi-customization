(function () {
  // ============================================================================================================
  // Hibernate Background Tabs with Status Bar Button or Keyboard Shortcut Mod
  // URL:         https://forum.vivaldi.net/post/396130 and https://forum.vivaldi.net/topic/60172/hibernate-background-tabs-keyboard-shortcut-hotkey
  ...
  let intervalID = setInterval(() => {
    ...
    if (browser) {
      ...
      hibernateBackgroundTabsCombined();
    }
  }, 300);
})();
